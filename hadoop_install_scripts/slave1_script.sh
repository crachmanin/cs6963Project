...
# After copying the ssh keys to master node, ssh is permissible since we have the flow capabilit
...
spawn ssh $slave1
expect "ubuntu@slave1:~$ "
send "sudo -i\r"
expect "root@slave1:~# "
send "echo '127.0.0.1 localhost slave1' >> /etc/hosts\r"
expect "root@slave1:~# "
...
expect "root@slave1:~# "
send "echo '$slave2 resourcemanager-link-1 resourcemanager-0 resourcemanager\n' >> /etc/hosts\r"
expect "root@slave1:~# "
send "exit\r"
expect "ubuntu@slave1:~$ "
